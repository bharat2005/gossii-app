...
const RegisterEmail = ({handleBlur, handleChange, handleSubmit, touched, errors, values, setStep, setFieldTouched}) => {
  ...
  return (
    ...
    <View>
          <Text style={{fontFamily:'light', fontSize:15, color:'gray'}}>
            To Register for Gossii, you need to have a gmail account. Your account will be created immediately after email registration
          </Text>
        </View>
...
<Pressable onPress={()=>router.replace('/(auth)/login')} style={{justifyContent:'center ', alignItems:'center'}}>
  <Text style={{fontFamily:'light', fontSize:15, color:'gray'}}>
