...
const reportOptions = [
  { option: "Spam or Fake Account", key: 1 },
  { option: "Harassment or Bullying", key: 2 },
  { option: "Inappropriate or Sexual Behavior", key: 3 },
  { option: "Impersonation or Misrepresentation", key: 4 },
  { option: "Others", key: 5 },
];
...
const ReportUser = () => {
    ...
    const {mutate, isPending} = useUserReport()
...
const handleReportPress = () =>{
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      <ReportUserTabBar selectedOption={selectedOption} textReason={textReason} handleReportPress={handleReportPress} isPending={isPending} />
